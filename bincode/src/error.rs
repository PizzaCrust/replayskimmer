...
pub enum ErrorKind {
    ...
    /// Returned if the deserializer attempts to deserialize a string that is not valid utf 16
...
impl StdError for ErrorKind {
    fn description(&self) -> &str {
        match *self {
            ...
            ErrorKind::InvalidUtf16Encoding() => "string is not valid utf16",
    ...
    fn cause(&self) -> Option<&error::Error> {
        match *self {
            ...
            ErrorKind::InvalidUtf16Encoding() => None,
...
impl From<std::string::FromUtf16Error> for Error {
    fn from(_: std::string::FromUtf16Error) -> Self {
        ErrorKind::InvalidUtf16Encoding().into()
    }
}

impl From<std::str::Utf8Error> for Error {
    fn from(a: Utf8Error) -> Self {
        ErrorKind::InvalidUtf8Encoding(a).into()
    }
}
...
impl fmt::Display for ErrorKind {
    fn fmt(&self, fmt: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            ErrorKind::InvalidUtf16Encoding() => write!(fmt, "{}", self.description()),
